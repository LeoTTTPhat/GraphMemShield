...
% admitted sensitive edges
\addplot[mark=square*, thick, color=orange!85!black,
         mark options={fill=orange!55}]
    coordinates {(0.1,3)(1.0,3)(3.0,5)};
\addlegendentry{admitted sensitive edges}
% victim leaked edges
\addplot[mark=triangle*, thick, color=red!75!black,
         mark options={fill=red!55}]
    coordinates {(0.1,1)(1.0,1)(3.0,2)};
\addlegendentry{victim leaked edges}
\end{axis}
\end{tikzpicture}
